...
共有 64 个密码子，它们又分别对应 20 种氨基酸；不过，在这个练习中，并非所有的密码子序列和对应的氨基酸都很重要。
只要程序能处理一个密码子，就应该能处理所有密码子。
不过，你可以随意扩展测试套件中的列表，把它们全部包含进去。
...
想进一步了解，请参阅[维基百科上的蛋白质翻译][protein-translation]。
