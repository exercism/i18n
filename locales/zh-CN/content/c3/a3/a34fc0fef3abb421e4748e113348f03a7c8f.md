...
学习 Scala 的最佳起点，是简短的 [Tour of Scala](https://docs.scala-lang.org/tour/tour-of-scala.html) 和 [Scala Book](https://docs.scala-lang.org/scala3/book/introduction.html)。
...
你可以在[这里](https://docs.scala-lang.org/online-courses.html)找到一份全面的在线课程列表。
