...
Cada track debe tener un directorio `docs` con los siguientes archivos:
...
**Propósito:** Una breve introducción al lenguaje.

**Se muestra en:** La página del track, siempre que el estudiante no se haya unido al track.
...
Consulta [esta página](https://exercism.org/tracks/fsharp) para ver cómo se ve al renderizarse (nota: no debes haberte unido ya al track).

## Archivo: `INSTALLATION.md`

**Propósito:** Describir lo que el estudiante necesita instalar para poder trabajar en el track en su sistema local usando la CLI.

**Se muestra en:** La página de documentación del track en `https://exercism.org/docs/tracks/<track>/installation`.
...
Consulta [esta página](https://exercism.org/docs/tracks/fsharp/installation) para ver cómo se ve al renderizarse.

## Archivo: `LEARNING.md`

**Propósito:** Enlaces a recursos de aprendizaje.

**Se muestra en:** La página de documentación del track en `https://exercism.org/docs/tracks/<track>/learning`.
...
Consulta [esta página](https://exercism.org/docs/tracks/fsharp/learning) para ver cómo se ve al renderizarse.

## Archivo: `SNIPPET.txt`

**Propósito:** Dar una impresión visual de cómo se ve la sintaxis del lenguaje.

**Se muestra en:** La página del track, siempre que el estudiante no se haya unido al track.

El fragmento debe ser relativamente pequeño (unas 10 líneas).
...
## Archivo: `REPRESENTER_NORMALIZATIONS.md`

**Propósito:** Enumerar las normalizaciones que el representer aplica a una solución.
...
## Archivo: `RESOURCES.md`

**Propósito:** Enlaces a recursos útiles.

**Se muestra en:** La página de documentación del track en `https://exercism.org/docs/tracks/<track>/resources`.
...
Consulta [esta página](https://exercism.org/docs/tracks/fsharp/resources) para ver cómo se ve al renderizarse.

## Archivo: `TESTS.md`

**Propósito:** Describir todo lo relacionado con la ejecución de las pruebas en el track.

**Se muestra en:** La página de documentación del track en `https://exercism.org/docs/tracks/<track>/tests`.
...
Consulta [esta página](https://exercism.org/docs/tracks/fsharp/tests) para ver cómo se ve al renderizarse.

## Archivo: `config.json`

**Propósito:** Indicar al sitio web qué páginas están disponibles.

**Se muestra en:** (no se muestra)
...
Es posible agregar documentos adicionales si así lo deseas.
Para hacerlo, debes hacer dos cosas:

1. Crear el documento dentro del directorio `docs` (p. ej., `docs/PACKAGES.md`)
2. Agregar una entrada al archivo `docs/config.json` para el nuevo documento.
   Por ejemplo:
...
Una vez fusionado en `main`, el documento se puede encontrar en `https://exercism.org/docs/tracks/<track_slug>/<document_slug>` (p. ej., `https://exercism.org/docs/tracks/fsharp/packages`)
