...
`nonFractional` y `nonNegative` son los campos de un registro que no existe fuera de un argumento de tipo, así que es adecuado darles el tipo `()`, llamado el __tipo unit__, que no contiene información más allá del hecho de que está ahí.
