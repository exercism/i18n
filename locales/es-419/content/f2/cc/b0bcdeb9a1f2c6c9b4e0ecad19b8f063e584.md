...
En Enumeración conociste los métodos de enumeración `count`, `any?`, `select`, `all` y `map`.
Aquí tienes un repaso de ellos, con algunos extras añadidos:
...
Si solo necesitas uno de los valores, puedes usar el símbolo especial `_` para indicar que uno de los valores no se necesita.
Esto ayuda a la claridad de quien lee el código y además es una optimización del rendimiento.
