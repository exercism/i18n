...
Una plantilla es un string o un archivo que se usa para producir cualquier tipo de salida de string según la entrada.
...
Entre otras cosas, también puedes usar condiciones para hacer comprobaciones dentro de las plantillas:
