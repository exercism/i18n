...
A diferencia de `List`, que es una [importación predeterminada][default-imports], el módulo `Array` se debe importar de forma explícita, usando `import Array` o algo similar.
...
Los arrays se manipulan con las funciones definidas en el [módulo `Array`][array-module].
