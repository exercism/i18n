...
Las listas se manipulan mediante funciones y operadores definidos en el [módulo `List`][list-module] o mediante la [coincidencia de patrones][list-destructuring].
