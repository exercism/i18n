...
WebAssembly es una tecnología que se encuentra en la intersección entre el desarrollo web y la programación de sistemas.

Si eres desarrollador web y no llevaste cursos de programación de sistemas o de sistemas operativos como parte de una carrera de Ciencias de la Computación, las caricaturas sobre código, los blogs y los videos de Lin Clark pueden serte de mucha ayuda para entender algunos de los conceptos de sistemas poco familiares sobre los que se construye WebAssembly:
