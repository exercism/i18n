...
El módulo `gleam/option` también define varias funciones útiles para trabajar con tipos `Option`, como `unwrap`, que devuelve el contenido de un `Option` o un valor por defecto si es `None`.
