...
Tienes tres tareas, y cada una recibirá una línea de log y te pedirá que hagas algo con ella.
...
Debes eliminar los espacios en blanco al principio y al final:
...
Implementa la función `logLevel()` para devolver el nivel de log de una línea de log, que debe devolverse en minúsculas:
