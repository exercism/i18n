...
Los ejercicios, los tracks y los conceptos se identifican con un UUID. [configlet](/docs/building/configlet) puede generar UUID nuevos y válidos.

## Uso

El comando `uuid` se puede usar para generar uno o más UUID.
