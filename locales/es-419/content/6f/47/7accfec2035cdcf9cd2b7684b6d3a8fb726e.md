...
La desestructuración puede vincular valores en enlaces `let`, en argumentos de funciones y, por supuesto, en expresiones case, siempre que solo haya una forma posible para los datos.
