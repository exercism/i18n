...
En Haxe, se puede definir una jerarquía de clases usando la _herencia_, que permite que una clase derivada (`Car`) herede el comportamiento y los datos de su clase padre (`Vehicle`).
