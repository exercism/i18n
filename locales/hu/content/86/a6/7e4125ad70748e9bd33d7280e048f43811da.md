...
Ha például a Hello World feladat tesztjeit szeretnéd futtatni, ezt írnád be:
...
- Core, standard (olyan nagyon gyakori függvényeket biztosít, mint például az [array](https://www.php.net/manual/en/ref.array.php) vagy a [string](https://www.php.net/manual/en/ref.strings.php) függvények)
