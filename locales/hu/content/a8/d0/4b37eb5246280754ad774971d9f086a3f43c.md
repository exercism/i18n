...
Minden kurzusnak rendelkeznie kell egy `docs` könyvtárral, amely a következő fájlokat tartalmazza:
...
**Rendeltetés:** Rövid bevezető a nyelvhez.

**Megjelenik:** A kurzus oldalán, feltéve, hogy a tanuló még nem csatlakozott a kurzushoz.
...
Nézd meg [ezt az oldalt](https://exercism.org/tracks/fsharp), hogy lásd, hogyan néz ki megjelenítve (megjegyzés: a kurzushoz még nem szabad csatlakoznod).

## Fájl: `INSTALLATION.md`

**Rendeltetés:** Leírja, mit kell a tanulónak telepítenie ahhoz, hogy a kurzuson a saját gépén a CLI használatával dolgozhasson.

**Megjelenik:** A kurzus dokumentációs oldalán: `https://exercism.org/docs/tracks/<track>/installation`.
...
Nézd meg [ezt az oldalt](https://exercism.org/docs/tracks/fsharp/installation), hogy lásd, hogyan néz ki megjelenítve.

## Fájl: `LEARNING.md`

**Rendeltetés:** Tanulási forrásokra mutató hivatkozások.

**Megjelenik:** A kurzus dokumentációs oldalán: `https://exercism.org/docs/tracks/<track>/learning`.
...
Nézd meg [ezt az oldalt](https://exercism.org/docs/tracks/fsharp/learning), hogy lásd, hogyan néz ki megjelenítve.

## Fájl: `SNIPPET.txt`

**Rendeltetés:** Vizuális benyomást adni a nyelv szintaxisáról.

**Megjelenik:** A kurzus oldalán, feltéve, hogy a tanuló még nem csatlakozott a kurzushoz.

A részlet legyen viszonylag rövid (körülbelül 10 sor).
...
## Fájl: `REPRESENTER_NORMALIZATIONS.md`

**Rendeltetés:** A representer által egy megoldáson alkalmazott normalizálások felsorolása.
...
**Rendeltetés:** Hasznos forrásokra mutató hivatkozások.

**Megjelenik:** A kurzus dokumentációs oldalán: `https://exercism.org/docs/tracks/<track>/resources`.
...
Nézd meg [ezt az oldalt](https://exercism.org/docs/tracks/fsharp/resources), hogy lásd, hogyan néz ki megjelenítve.

## Fájl: `TESTS.md`

**Rendeltetés:** Mindent leír, ami a kurzuson a tesztek futtatásához kapcsolódik.

**Megjelenik:** A kurzus dokumentációs oldalán: `https://exercism.org/docs/tracks/<track>/tests`.
...
Nézd meg [ezt az oldalt](https://exercism.org/docs/tracks/fsharp/tests), hogy lásd, hogyan néz ki megjelenítve.

## Fájl: `config.json`

**Rendeltetés:** Megmondja a weboldalnak, milyen oldalak érhetők el.
...
Lehetőség van további dokumentumokat hozzáadni, ha szeretnél.
Ehhez két dolgot kell tenned:

1. Hozd létre a dokumentumot a `docs` könyvtárban (pl. `docs/PACKAGES.md`)
2. Adj hozzá egy bejegyzést a `docs/config.json` fájlhoz az új dokumentumhoz.
   Például:
...
Miután bekerült a `main` ágba, a dokumentum itt található: `https://exercism.org/docs/tracks/<track_slug>/<document_slug>` (pl. `https://exercism.org/docs/tracks/fsharp/packages`)
