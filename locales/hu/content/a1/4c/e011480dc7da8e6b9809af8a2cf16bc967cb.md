...
A feladat története egy lasagne-recepten keresztül mutatja be az alapvető [függvények][types-function], [operátorok][concepts-operators], [egész számok][types-integer] és [visszatérési értékek][concepts-return_values] létrehozását.

## Feladatok

A történet segít a függvények definiálásában:

- A várt sütési idő visszaadása.
- A sütőben maradt idő kiszámítása.
- Az előkészítési idő kiszámítása a lasagne rétegeinek számából.
- A teljes sütési idő kiszámítása.

## Implementációk

- [C#: lucians-luscious-lasagna][implementation-csharp] (referenciaimplementáció)
