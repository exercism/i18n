...
Sokaknak rendkívül bosszantó tud lenni, ha nem a megfelelő névmással szólítják meg őket, és gyakran bántó is.
Ezért lehetővé tesszük, hogy az emberek megadják, milyen névmással szeretnék, hogy szólítsák őket, majd ezeket a névmásokat azokban a helyzetekben jelenítjük meg, ahol interakció történik (például amikor ajánlást írnak).

A névmásaidat úgy állíthatod be, hogy a [beállításaid oldalán](https://exercism.org/settings) kitöltöd egy mintamondat hiányzó részeit.
Adunk néhány gyakori lehetőséget, de bármit beírhatsz.

- Ha a „Felhasználónév használata” lehetőséget választod, azt fogjuk javasolni másoknak, hogy amikor rád hivatkoznak, mindig a felhasználónevedet használják névmás helyett.
- Ha az „Üresen hagyás” lehetőséget választod, egyáltalán nem jelenítünk meg névmást vagy javaslatot.

Ha másoknál fel vannak tüntetve a névmásaik, kérünk, tiszteld őket.
