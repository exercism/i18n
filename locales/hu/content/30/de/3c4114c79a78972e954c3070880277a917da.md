...
- Specializáltabb funkcionalitás olyan csomagokban, amelyeket használat előtt telepíteni kell (és amelyek az Exercismen nem érhetők el).
...
A legegyszerűbb (_és az Exercismen belül az egyetlen lehetőség_), hogy a `Random.shuffle()` függvénnyel véletlen sorrendbe teszed az elemeket, majd az első `n` elemet használod.
...
Az Exercismen kívül számos, véletlennel, valószínűségszámítással és statisztikával kapcsolatos, telepíthető csomag létezik.
