...
A feladatokat, kurzusokat és fogalmakat egy UUID azonosítja. A [configlet](/docs/building/configlet) új, érvényes UUID-kat tud generálni.

## Használat

Az `uuid` paranccsal egy vagy több UUID-t generálhatsz.
