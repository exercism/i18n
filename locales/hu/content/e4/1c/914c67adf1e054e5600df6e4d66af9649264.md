...
Általános szabályként az Exercism-ön, valamint sok más szervezet és projekt stílusútmutatójában nem módosítunk olyan értékeket, amik `const SCREAMING_SNAKE_CASE` formátumúak. Technikailag az értékek _módosíthatók_, de az átláthatóság és az elvárások kezelése miatt az Exercism-ön ezt nem ajánljuk. Ha viszont _muszáj_ kikényszeríteni, használd az [`Object.freeze(value)`][mdn-object-freeze] hívást.
