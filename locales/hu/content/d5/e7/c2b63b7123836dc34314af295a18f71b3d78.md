...
A felsorolásról szóló fejezetben megismerkedtél a `count`, `any?`, `select`, `all` és `map` felsorolási metódussal.
Íme egy összefoglaló róluk, néhány extrával kiegészítve:
...
Ez egyszerre segíti a fejlesztői átláthatóságot, és egyben teljesítményoptimalizálás is.
...
Felsorolhatsz egymásba ágyazott blokkokban is, és a metódusokat láncba fűzheted.
Például ha van egy tömbünk, amely állatokról szóló hash-eket tartalmaz, és ki szeretnénk gyűjteni a rövid nevű állatokat, valami ilyesmit tehetünk:
