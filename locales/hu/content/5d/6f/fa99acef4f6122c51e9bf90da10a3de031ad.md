...
## A „Could not find a command named frontend_server.dart.snapshot” hiba kezelése

Tegyük fel, hogy van egy feladat, amelyet már megoldottál és beküldtél, és egy idő után visszatérsz hozzá.
Előfordulhat, hogy a tesztelés során ezzel a hibával találkozol:
...
A [megoldás][solution] az, hogy törlöd a `pubspec.lock` fájlt.
Ezután futtasd újra a dart parancsot.
