# Concepts de simulateur de robot
...
- **Références**
- **Visibilité / `pub`**
- **`match` avec le filtrage par motifs**
- **Traits**
  - attributs `#[derive]`
- **blocs `impl`**
- **Itérateurs**
...
Tiré de [« CodeGradox »](https://exercism.org/tracks/rust/exercises/robot-simulator/solutions/2464130c2440427f98aae078a91e803d)
