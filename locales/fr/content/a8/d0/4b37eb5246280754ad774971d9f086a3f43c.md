...
Chaque parcours doit avoir un répertoire `docs` contenant les fichiers suivants :
...
**Objectif :** une brève introduction au langage.

**Affiché sur :** la page du parcours, à condition que l'apprenant n'ait pas rejoint le parcours.
...
Consulte [cette page](https://exercism.org/tracks/fsharp) pour voir le rendu (attention : tu ne dois pas avoir déjà rejoint le parcours).

## Fichier : `INSTALLATION.md`

**Objectif :** décrire ce que l'apprenant doit installer pour pouvoir travailler sur le parcours en local avec la CLI.

**Affiché sur :** la page de documentation du parcours à l'adresse `https://exercism.org/docs/tracks/<track>/installation`.
...
Consulte [cette page](https://exercism.org/docs/tracks/fsharp/installation) pour voir le rendu.

## Fichier : `LEARNING.md`

**Objectif :** des liens vers des ressources d'apprentissage.

**Affiché sur :** la page de documentation du parcours à l'adresse `https://exercism.org/docs/tracks/<track>/learning`.
...
Consulte [cette page](https://exercism.org/docs/tracks/fsharp/learning) pour voir le rendu.

## Fichier : `SNIPPET.txt`

**Objectif :** donner un aperçu visuel de la syntaxe du langage.

**Affiché sur :** la page du parcours, à condition que l'apprenant n'ait pas rejoint le parcours.

L'extrait doit être relativement court (une dizaine de lignes).
...
## Fichier : `REPRESENTER_NORMALIZATIONS.md`

**Objectif :** lister les normalisations que le representer applique à une solution.
...
## Fichier : `RESOURCES.md`

**Objectif :** des liens vers des ressources utiles.

**Affiché sur :** la page de documentation du parcours à l'adresse `https://exercism.org/docs/tracks/<track>/resources`.
...
Consulte [cette page](https://exercism.org/docs/tracks/fsharp/resources) pour voir le rendu.

## Fichier : `TESTS.md`

**Objectif :** décrire tout ce qui concerne l'exécution des tests dans le parcours.

**Affiché sur :** la page de documentation du parcours à l'adresse `https://exercism.org/docs/tracks/<track>/tests`.
...
Consulte [cette page](https://exercism.org/docs/tracks/fsharp/tests) pour voir le rendu.

## Fichier : `config.json`

**Objectif :** indiquer au site quelles pages sont disponibles.

**Affiché sur :** (non affiché)
...
Il est possible d'ajouter des documents supplémentaires si tu le souhaites.
Pour cela, tu dois faire deux choses :

1. Crée le document dans le répertoire `docs` (par exemple `docs/PACKAGES.md`)
2. Ajoute une entrée pour le nouveau document dans le fichier `docs/config.json`.
   Par exemple :
...
Une fois la modification fusionnée dans `main`, le document est accessible à l'adresse `https://exercism.org/docs/tracks/<track_slug>/<document_slug>` (par exemple `https://exercism.org/docs/tracks/fsharp/packages`)
