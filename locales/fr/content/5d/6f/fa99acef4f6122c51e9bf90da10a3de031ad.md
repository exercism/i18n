...
## Gère l'erreur « Could not find a command named frontend_server.dart.snapshot »

Imagine que tu as déjà résolu et soumis un exercice, et que tu y reviens après un moment. Tu peux tomber sur cette erreur au moment de le tester :
...
La [solution][solution] consiste à supprimer le fichier `pubspec.lock`. Relance ensuite la commande dart.
