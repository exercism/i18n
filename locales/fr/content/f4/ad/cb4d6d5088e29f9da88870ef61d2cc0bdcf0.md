...
Un [`Dict`][dict] en Elm est un dictionnaire immuable contenant zéro ou plusieurs paires clé-valeur.

Les dictionnaires se manipulent à l'aide des fonctions et des opérateurs définis dans le [module `Dict`][dict-module].

Les annotations de type d'un dictionnaire s'écrivent de la façon suivante :
...
On peut créer des dictionnaires de la façon suivante :
...
La liste est ordonnée selon les clés.
