...
Par exemple, pour lancer les tests de l'exercice Hello World, tu écrirais :
...
- Core, standard (qui fournit des fonctions très courantes comme les fonctions de [tableau](https://www.php.net/manual/en/ref.array.php) ou de [_string_](https://www.php.net/manual/en/ref.strings.php))
