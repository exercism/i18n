...
Les exercices, les parcours et les concepts sont identifiés par un UUID. [configlet](/docs/building/configlet) peut générer de nouveaux UUID valides.

## Utilisation

La commande `uuid` permet de générer un ou plusieurs UUID.
