...
WebAssembly est une technologie à la croisée du développement web et de la programmation système.

Si tu fais du développement web et que tu n'as jamais suivi de cours de programmation système ou de systèmes d'exploitation dans le cadre d'un cursus d'informatique, les bandes dessinées de Lin Clark consacrées au code, ses articles de blog et ses vidéos peuvent t'être très utiles pour te familiariser avec certains concepts système, souvent méconnus, sur lesquels WebAssembly s'appuie :
