...
Le meilleur point de départ pour te lancer avec Scala, c'est le court [Tour of Scala](https://docs.scala-lang.org/tour/tour-of-scala.html) et le [Scala Book](https://docs.scala-lang.org/scala3/book/introduction.html).
...
Tu trouveras une liste complète de cours en ligne [ici](https://docs.scala-lang.org/online-courses.html).
