...
[Зіставлення зі зразками][pattern-matching] уможливлює виразний розгалужений код, а [деструктуризація][destructuring] дає елегантне звʼязування значень зі змінними.

### Просте зіставлення зі зразками

Зіставлення зі зразками може звʼязувати значення зі змінними або відкидати їх за допомогою символу-замінника `_`, використовуючи конструкцію `case`.
...
Деструктуризація може звʼязувати значення в привʼязках `let`, аргументах функцій і, звісно, у виразах `case`, коли для даних можлива лише одна форма.
...
Деструктуризацію також можна застосовувати до [записів][records-pattern-matching] або разом із [ключовим словом `as`][as-keyword].
