...
[Зіставлення зі зразком][pattern-matching] дає змогу писати виразний розгалужений код, а [деструктуризація][destructuring] забезпечує елегантне звʼязування значень зі змінними.

## Просте зіставлення зі зразком

Зіставлення зі зразком може звʼязувати значення зі змінними або відкидати їх за допомогою джокера `_`, використовуючи конструкцію `case`.
...
Деструктуризація може звʼязувати значення у звʼязуваннях `let`, в аргументах функції та, звісно, у виразах case, коли для даних можлива лише одна форма.
...
Деструктуризацію також можна використовувати для [записів][records-pattern-matching] або разом із [ключовим словом `as`][as-keyword].
