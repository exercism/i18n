...
WebAssembly - це технологія на перетині веброзробки та системного програмування.

Якщо ми веброзробники й не вивчали системного програмування чи операційних систем у межах навчальної програми з інформатики, то комікси про код, блоги та відео Лін Кларк можуть дуже допомогти заповнити прогалини в незнайомих системних концепціях, на яких ґрунтується WebAssembly:
