...
Додаваймо записи до мапи за допомогою [put][map-put-javadoc].
...
Виклик `put` з тим самим ключем оновить значення цього ключа.
...
Щоб отримати значення за ключем, скористаймося [get][map-get-javadoc].
...
Видаляймо записи за допомогою [remove][map-remove-javadoc].
...
За допомогою методів [keySet][map-keyset-javadoc] або [values][map-values-javadoc] можна отримати ключі чи значення мапи як Set або колекцію відповідно.
