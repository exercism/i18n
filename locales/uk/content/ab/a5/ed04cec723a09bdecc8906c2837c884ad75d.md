...
- **Посилання**
- **Видимість / `pub`**
- **`match` зі зіставленням зі зразком**
- **Риси**
  - атрибути `#[derive]`
- **Блоки `impl`**
- **Ітератори**
...
Взято з ["CodeGradox"](https://exercism.org/tracks/rust/exercises/robot-simulator/solutions/2464130c2440427f98aae078a91e803d)
