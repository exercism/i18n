...
*Combinators* - це слова вищого порядку, які дають власні назви типовим прийомам переставляння стека. Звертатися до них означає писати набагато менше `dup`, `swap`, `over`, `rot`.
...
`keep`, `dip`, `bi`, `bi@`, `bi*` містяться в [`kernel`][kernel], а `cleave` і довші варіанти - у [`combinators`][combinators].
