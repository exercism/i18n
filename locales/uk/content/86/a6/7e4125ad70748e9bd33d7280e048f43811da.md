...
Запускаємо тести командою:

```shell
phpunit test_file.php
```

Наприклад, тести для вправи Hello World запускаємо так:
...
- Core, standard (надають дуже поширені функції, як-от функції для [масивів](https://www.php.net/manual/en/ref.array.php) чи [рядків тексту](https://www.php.net/manual/en/ref.strings.php) (англ. string))
