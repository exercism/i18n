...
Найпоширеніший спосіб додати елемент до масиву - це оператор `::` (cons):
...
Масивами керують за допомогою функцій та операторів, визначених у модулі [`List`][list-module], або за допомогою [зіставлення зі зразком][list-destructuring]
