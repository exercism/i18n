...
Найкраще почати нашу подорож у Scala з короткого [Tour of Scala](https://docs.scala-lang.org/tour/tour-of-scala.html) та [Scala Book](https://docs.scala-lang.org/scala3/book/introduction.html)
...
Повний список онлайн-курсів можна знайти [тут](https://docs.scala-lang.org/online-courses.html).
