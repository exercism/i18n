...
У JavaScript екземпляри [`Array`][arrays-concept] є звичайними обʼєктами, оздобленими безліччю [корисних методів][array-docs].
Він містить властивість `length`, а також методи для перебирання, аналізу і зміни масиву.
Елементи масиву є індексованими властивостями цього масиву.
Замість того, щоб вручну перебирати ці індексовані властивості, скористаймося аналізом масивів.
Багато вбудованих функцій, які аналізують вміст масиву, приймають як аргумент функцію, що повертає правду або неправду. Таку функцію називають [`predicate`][predicate_in_programming]

Загалом користуватися абстракціями та вбудованими методами ідіоматичніше, зрозуміліше й легше підтримувати, ніж використовувати `for` чи `.forEach`.
