...
[`Array`][array] в Elm - це швидка незмінна колекція з нуля або більше значень одного типу.
...
Елемент масиву встановлюють за допомогою `Array.set`:
...
Масивами керують функції, визначені в [модулі `Array`][array-module].
