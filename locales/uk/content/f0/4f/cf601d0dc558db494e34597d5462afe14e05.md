# Додаткові ресурси для Python

- [Official Python 3 Documentation and Reference][python docs]
- [The Python Library Reference][The Python Library Reference]
- [The Docs on pip][pip]
- [Tall, Snarky Canadian (_блог розробника ядра Python Бретта Кеннона_)][Tall, Snarky Canadian]
...
- [Fluent Python, 2nd Edition][Fluent Python 2] (_безкоштовний доступ можна знайти через бібліотеку або онлайн_)
- [Fluent Python Notebooks][fluent-notebooks] (_вони базуються на першому виданні, але все одно дуже добрі_)
...
- [Mouse vs Python (_блог Майка Дрісколла_)][mouse vs python]
