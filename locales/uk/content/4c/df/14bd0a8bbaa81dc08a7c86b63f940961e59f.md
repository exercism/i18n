...
Кожна вправа, трек і концепція позначаються UUID. [configlet](/docs/building/configlet) уміє генерувати нові коректні UUID.

## Використання

Команду `uuid` можна використати, щоб згенерувати один або кілька UUID.
