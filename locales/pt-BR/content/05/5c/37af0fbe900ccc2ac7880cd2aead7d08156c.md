...
No entanto, se você colocar `...` antes do tipo do último parâmetro, a função pode aceitar qualquer número de argumentos no final.
Isso faz do último parâmetro um _parâmetro variádico_.
...
Uma função pode ter no máximo um parâmetro variádico, e ele deve ser o último parâmetro.
...
Para passar um slice ao parâmetro variádico, coloque `...` depois dele:
