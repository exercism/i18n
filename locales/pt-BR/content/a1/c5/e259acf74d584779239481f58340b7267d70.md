...
O [Delphi Basics](http://www.delphibasics.co.uk/) é uma boa referência sobre Delphi.

Também recomendo a leitura do "[A Beginner's Guide to Delphi Programming](http://delphi.about.com/od/beginners/a/delphicourse.htm)", do [delphi.about.com](http://delphi.about.com/), uma ótima introdução à programação em Delphi.

Aqui está uma lista de tópicos do guia para iniciantes mencionado acima que você vai achar úteis:
