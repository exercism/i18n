...
Cada trilha precisa ter um diretório `docs` com os seguintes arquivos:
...
**Objetivo:** Uma breve introdução à linguagem.

**Exibido em:** A página da trilha, desde que o estudante ainda não tenha entrado na trilha.
...
Confira [esta página](https://exercism.org/tracks/fsharp) para ver como isso fica renderizado (observação: você não pode já ter entrado na trilha).

## Arquivo: `INSTALLATION.md`

**Objetivo:** Descreva o que o estudante precisa instalar para conseguir trabalhar na trilha no seu sistema local usando a CLI.

**Exibido em:** A página de documentação da trilha em `https://exercism.org/docs/tracks/<track>/installation`.
...
Confira [esta página](https://exercism.org/docs/tracks/fsharp/installation) para ver como isso fica renderizado.

## Arquivo: `LEARNING.md`

**Objetivo:** Links para recursos de aprendizado.

**Exibido em:** A página de documentação da trilha em `https://exercism.org/docs/tracks/<track>/learning`.
...
Confira [esta página](https://exercism.org/docs/tracks/fsharp/learning) para ver como isso fica renderizado.

## Arquivo: `SNIPPET.txt`

**Objetivo:** Dê uma impressão visual de como é a sintaxe da linguagem.

**Exibido em:** A página da trilha, desde que o estudante ainda não tenha entrado na trilha.

O trecho deve ser relativamente pequeno (umas 10 linhas).
...
## Arquivo: `REPRESENTER_NORMALIZATIONS.md`

**Objetivo:** Liste as normalizações que o representer aplica a uma solução.
...
**Objetivo:** Links para recursos úteis.

**Exibido em:** A página de documentação da trilha em `https://exercism.org/docs/tracks/<track>/resources`.
...
Confira [esta página](https://exercism.org/docs/tracks/fsharp/resources) para ver como isso fica renderizado.

## Arquivo: `TESTS.md`

**Objetivo:** Descreva tudo relacionado a rodar os testes na trilha.

**Exibido em:** A página de documentação da trilha em `https://exercism.org/docs/tracks/<track>/tests`.
...
Confira [esta página](https://exercism.org/docs/tracks/fsharp/tests) para ver como isso fica renderizado.

## Arquivo: `config.json`

**Objetivo:** Informe ao site quais páginas estão disponíveis.

**Exibido em:** (não exibido)
...
É possível adicionar documentos extras, se você quiser.
Para isso, você precisa fazer duas coisas:

1. Crie o documento dentro do diretório `docs` (por exemplo, `docs/PACKAGES.md`)
2. Adicione uma entrada para o novo documento no arquivo `docs/config.json`.
   Por exemplo:
...
Depois de mesclado na `main`, o documento pode ser encontrado em `https://exercism.org/docs/tracks/<track_slug>/<document_slug>` (por exemplo, `https://exercism.org/docs/tracks/fsharp/packages`)
