...
Uma [`List`][lists] no Elm é uma coleção imutável de zero ou mais valores do mesmo tipo.

Listas podem ser definidas da seguinte forma:
...
A maneira mais comum de adicionar um elemento a uma lista é usando o operador `::` (cons):
