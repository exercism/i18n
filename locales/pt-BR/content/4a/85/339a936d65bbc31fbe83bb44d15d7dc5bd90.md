...
Python é (_como [diz a Wikipédia][wikipython]_) uma *linguagem de programação de alto nível e de propósito geral*.
Ela pode ser usada para escrever uma grande variedade de tipos diferentes de software, de videogames a servidores HTTP e ferramentas de linha de comando, além de um monte de outras coisas.
Ela é especialmente boa em 'colar' sistemas e programas diferentes.


E acreditamos que a melhor forma de aprender é _brincar_ e _praticar_ com projetos de programação grandes e pequenos, ou com problemas pequenos como os daqui do Exercism!


Abaixo você encontra mais alguns pontos de partida para começar sua jornada de aprendizado, recomendados pela nossa comunidade.
...
- [Automate the Boring Stuff with Python (_livro_)][automate the boring stuff]
- [Automate the Boring Stuff with Python Workbook (_exercícios_)][automate the boring stuff workbook]
...
- [Learn X in Y minutes (onde X = Python3)][Learn X in Y minutes]
