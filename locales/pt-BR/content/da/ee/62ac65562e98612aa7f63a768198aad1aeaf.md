...
Todas elas recebem dois operandos, e o segundo indica o índice do bit que será manipulado no primeiro operando.
Todas copiam o bit selecionado para a **flag de carry (CF)**.
...
Os bits que seriam descartados por um deslocamento são movidos para a extremidade oposta.
