...
O matemático grego [Nicômaco](https://en.wikipedia.org/wiki/Nicomachus) criou um esquema de classificação para números inteiros positivos, identificando cada um como pertencente exclusivamente a uma das categorias **perfect**, **abundant** ou **deficient**, com base na sua [soma dos divisores próprios](https://en.wikipedia.org/wiki/Aliquot_sum). A soma dos divisores próprios é definida como a soma dos fatores de um número, sem incluir o próprio número. Por exemplo, a soma dos divisores próprios de 15 é (1 + 3 + 5) = 9.
