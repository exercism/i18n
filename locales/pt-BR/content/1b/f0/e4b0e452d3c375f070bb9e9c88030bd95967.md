...
O WebAssembly é uma tecnologia na interseção entre o desenvolvimento web e a programação de sistemas.

Se você trabalha com desenvolvimento web e não fez cursos de programação de sistemas ou de sistemas operacionais como parte de um curso de Ciência da Computação, os quadrinhos de código, os blogs e os vídeos da Lin Clark podem ajudar bastante a preencher alguns dos conceitos de sistemas pouco familiares nos quais o WebAssembly se baseia:
