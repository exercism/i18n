...
Exercícios, trilhas e conceitos são identificados por um UUID. O [configlet](/docs/building/configlet) pode gerar UUIDs novos e válidos.

## Uso

O comando `uuid` pode ser usado para gerar um ou mais UUIDs.
