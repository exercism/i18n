...
Το καλύτερο μέρος για να ξεκινήσεις το ταξίδι σου με τη Scala είναι το σύντομο [Tour of Scala](https://docs.scala-lang.org/tour/tour-of-scala.html) και το [Scala Book](https://docs.scala-lang.org/scala3/book/introduction.html)
...
Μπορείς να βρεις μια ολοκληρωμένη λίστα με διαδικτυακά μαθήματα [εδώ](https://docs.scala-lang.org/online-courses.html).
