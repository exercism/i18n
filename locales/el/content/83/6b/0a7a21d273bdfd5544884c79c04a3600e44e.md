...
Αυτό το φίλτρο βγάζει ένα αποτέλεσμα _Boolean_.
...
# => ["first   second           third fourth"]
```
Μόνο ένα αποτέλεσμα: η _σταθερή συμβολοσειρά_ `\s+` δεν βρέθηκε στην είσοδο.

Το `split` με ένα όρισμα δεν μπορεί να χειριστεί _αυθαίρετα_ κενά.
...
Το κείμενο αντικατάστασης μπορεί να αναφέρεται στις υποσυμβολοσειρές που ταίριαξαν· χρησιμοποίησε ονομασμένες συλλήψεις και [παρεμβολή συμβολοσειρών][jq-interp].
