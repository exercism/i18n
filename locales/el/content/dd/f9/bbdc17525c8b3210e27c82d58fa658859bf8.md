...
Ένα πρότυπο είναι μια συμβολοσειρά ή ένα αρχείο που χρησιμοποιείται για να παράγει κάθε είδους έξοδο συμβολοσειράς, ανάλογα με την είσοδο.
...
Μεταξύ άλλων, μπορείς επίσης να χρησιμοποιήσεις συνθήκες για να ελέγχεις μέσα στα πρότυπα:
