...
Το WebAssembly είναι μια τεχνολογία στο σημείο τομής της ανάπτυξης ιστού και του προγραμματισμού συστημάτων.

Αν είσαι προγραμματιστής ιστού και δεν έχεις παρακολουθήσει μαθήματα προγραμματισμού συστημάτων ή λειτουργικών συστημάτων ως μέρος ενός προγράμματος Επιστήμης Υπολογιστών, τα καρτούν κώδικα, τα blogs και τα βίντεο της Lin Clark μπορούν να σε βοηθήσουν πολύ να καλύψεις κάποιες από τις άγνωστες έννοιες συστημάτων πάνω στις οποίες βασίζεται το WebAssembly:
