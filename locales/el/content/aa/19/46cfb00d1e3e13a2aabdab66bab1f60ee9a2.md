...
Η αποστολή σου είναι να υλοποιήσεις έναν αλγόριθμο δυαδικής αναζήτησης.
...
Μας επιτρέπει να περιορίσουμε γρήγορα τις πιθανές θέσεις του στοιχείου μας, μέχρι να το βρούμε ή μέχρι να εξαλείψουμε όλες τις πιθανές θέσεις.
...
- Αν έχουν εξαλειφθεί όλα τα στοιχεία της λίστας, τότε το στοιχείο δε βρίσκεται στη λίστα.
