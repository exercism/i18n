...
Κάθε διαδρομή πρέπει να έχει έναν κατάλογο `docs` με τα παρακάτω αρχεία:
...
**Σκοπός:** Μια σύντομη εισαγωγή στη γλώσσα.

**Εμφανίζεται σε:** Τη σελίδα της διαδρομής, εφόσον ο μαθητής δεν έχει εγγραφεί στη διαδρομή.
...
Δες [αυτή τη σελίδα](https://exercism.org/tracks/fsharp) για να δεις πώς φαίνεται όταν αποδοθεί (σημείωση: δεν πρέπει να έχεις ήδη εγγραφεί στη διαδρομή).

## Αρχείο: `INSTALLATION.md`

**Σκοπός:** Περιγράφει τι χρειάζεται να εγκαταστήσει ο μαθητής για να μπορεί να δουλεύει τη διαδρομή στο τοπικό του σύστημα χρησιμοποιώντας τη γραμμή εντολών.

**Εμφανίζεται σε:** Τη σελίδα τεκμηρίωσης της διαδρομής στο `https://exercism.org/docs/tracks/<track>/installation`.
...
Δες [αυτή τη σελίδα](https://exercism.org/docs/tracks/fsharp/installation) για να δεις πώς φαίνεται όταν αποδοθεί.

## Αρχείο: `LEARNING.md`

**Σκοπός:** Σύνδεσμοι προς πόρους μάθησης.

**Εμφανίζεται σε:** Τη σελίδα τεκμηρίωσης της διαδρομής στο `https://exercism.org/docs/tracks/<track>/learning`.
...
Δες [αυτή τη σελίδα](https://exercism.org/docs/tracks/fsharp/learning) για να δεις πώς φαίνεται όταν αποδοθεί.

## Αρχείο: `SNIPPET.txt`

**Σκοπός:** Δίνει μια οπτική εικόνα του πώς μοιάζει η σύνταξη της γλώσσας.

**Εμφανίζεται σε:** Τη σελίδα της διαδρομής, εφόσον ο μαθητής δεν έχει εγγραφεί στη διαδρομή.

Το απόσπασμα πρέπει να είναι σχετικά μικρό (περίπου 10 γραμμές).
...
## Αρχείο: `REPRESENTER_NORMALIZATIONS.md`

**Σκοπός:** Απαριθμεί τις κανονικοποιήσεις που εφαρμόζει ο representer σε μια λύση.
...
**Σκοπός:** Σύνδεσμοι προς χρήσιμους πόρους.

**Εμφανίζεται σε:** Τη σελίδα τεκμηρίωσης της διαδρομής στο `https://exercism.org/docs/tracks/<track>/resources`.
...
Δες [αυτή τη σελίδα](https://exercism.org/docs/tracks/fsharp/resources) για να δεις πώς φαίνεται όταν αποδοθεί.

## Αρχείο: `TESTS.md`

**Σκοπός:** Περιγράφει όλα όσα σχετίζονται με την εκτέλεση των tests στη διαδρομή.

**Εμφανίζεται σε:** Τη σελίδα τεκμηρίωσης της διαδρομής στο `https://exercism.org/docs/tracks/<track>/tests`.
...
Δες [αυτή τη σελίδα](https://exercism.org/docs/tracks/fsharp/tests) για να δεις πώς φαίνεται όταν αποδοθεί.

## Αρχείο: `config.json`

**Σκοπός:** Λέει στον ιστότοπο ποιες σελίδες είναι διαθέσιμες.

**Εμφανίζεται σε:** (δεν εμφανίζεται)
...
Μπορείς να προσθέσεις επιπλέον έγγραφα αν το επιθυμείς.
Για να το κάνεις, χρειάζεται να κάνεις δύο πράγματα:

1. Δημιούργησε το έγγραφο μέσα στον κατάλογο `docs` (π.χ. `docs/PACKAGES.md`)
2. Πρόσθεσε μια καταχώριση στο αρχείο `docs/config.json` για το νέο έγγραφο.
   Για παράδειγμα:
...
Μόλις γίνει merge στο `main`, το έγγραφο βρίσκεται στο `https://exercism.org/docs/tracks/<track_slug>/<document_slug>` (π.χ. `https://exercism.org/docs/tracks/fsharp/packages`)
