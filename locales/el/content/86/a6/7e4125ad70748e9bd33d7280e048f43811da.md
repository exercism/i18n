...
Για παράδειγμα, για να τρέξεις τα tests της άσκησης Hello World, εκτελείς:
...
- Core, standard (παρέχουν πολύ συνηθισμένες συναρτήσεις, όπως οι [array](https://www.php.net/manual/en/ref.array.php) ή οι [string](https://www.php.net/manual/en/ref.strings.php))
