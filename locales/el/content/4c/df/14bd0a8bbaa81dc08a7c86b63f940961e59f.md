...
Οι ασκήσεις, οι διαδρομές και οι έννοιες προσδιορίζονται με ένα UUID. Το [configlet](/docs/building/configlet) μπορεί να δημιουργήσει νέα, έγκυρα UUID.

## Χρήση

Η εντολή `uuid` μπορεί να χρησιμοποιηθεί για να δημιουργήσει ένα ή περισσότερα UUID.
