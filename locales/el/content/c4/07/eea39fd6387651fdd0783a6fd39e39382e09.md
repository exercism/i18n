...
Μοιάζει με τα λεξικά άλλων γλωσσών προγραμματισμού.
Η διεπαφή [Map][map-javadoc] ορίζει τις λειτουργίες πάνω σε έναν map.
...
Πρόσθεσε καταχωρήσεις στον map χρησιμοποιώντας τη μέθοδο [put][map-put-javadoc].
...
Η κλήση της `put` με το ίδιο κλειδί θα ενημερώσει την τιμή του κλειδιού.
