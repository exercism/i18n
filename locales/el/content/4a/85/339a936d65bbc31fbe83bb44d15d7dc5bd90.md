...
## Μάθε Python από το μηδέν
Η Python είναι (*όπως λέει η [Wikipedia][wikipython]*) μια *γενικού σκοπού και υψηλού επιπέδου γλώσσα προγραμματισμού*.
Μπορεί να χρησιμοποιηθεί για να γράψεις μια μεγάλη ποικιλία από διαφορετικά είδη λογισμικού, από βιντεοπαιχνίδια μέχρι διακομιστές HTTP και εργαλεία γραμμής εντολών, και πολλά άλλα ακόμη.
Είναι ιδιαίτερα καλή στο να "κολλάει" διαφορετικά συστήματα και προγράμματα μεταξύ τους.


Και πιστεύουμε πως ο καλύτερος τρόπος για να μάθεις είναι να *παίξεις* και να *εξασκηθείς* με έργα προγραμματισμού, μικρά και μεγάλα, ή με μικρά προβλήματα σαν αυτά εδώ στο Exercism!


Παρακάτω θα βρεις μερικά επιπλέον σημεία εκκίνησης για το ταξίδι της μάθησής σου, προτεινόμενα από την κοινότητά μας.
...
- [Automate the Boring Stuff with Python (_βιβλίο_)][automate the boring stuff]
- [Automate the Boring Stuff with Python Workbook (_ασκήσεις_)][automate the boring stuff workbook]
