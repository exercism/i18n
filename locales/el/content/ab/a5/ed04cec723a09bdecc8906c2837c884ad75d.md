...
- **Αναφορές**
- **Ορατότητα / `pub`**
- **`match` με αντιστοίχιση προτύπων**
- **Χαρακτηριστικά**
  - γνωρίσματα `#[derive]`
- **μπλοκ `impl`**
- **Επαναλήπτες**
...
Από ["CodeGradox"](https://exercism.org/tracks/rust/exercises/robot-simulator/solutions/2464130c2440427f98aae078a91e803d)
