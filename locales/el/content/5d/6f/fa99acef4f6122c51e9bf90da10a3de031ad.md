...
## Αντιμετώπιση του σφάλματος "Could not find a command named frontend_server.dart.snapshot"

Ας υποθέσουμε ότι έχεις μια άσκηση που την έχεις ήδη λύσει και υποβάλει, και επιστρέφεις σε αυτήν μετά από καιρό. Μπορεί να συναντήσεις αυτό το σφάλμα όταν την τεστάρεις:
...
Η [λύση][solution] είναι να διαγράψεις το αρχείο `pubspec.lock`. Έπειτα, τρέξε ξανά την εντολή dart.
