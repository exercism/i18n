...
Το [Delphi Basics](http://www.delphibasics.co.uk/) είναι μια καλή αναφορά για τη Delphi.

Σου προτείνω επίσης να διαβάσεις τον "[A Beginner's Guide to Delphi Programming](http://delphi.about.com/od/beginners/a/delphicourse.htm)" του [delphi.about.com](http://delphi.about.com/), που είναι μια ωραία εισαγωγή στον προγραμματισμό σε Delphi.

Ακολουθεί μια λίστα με θέματα από τον οδηγό για αρχάριους που αναφέρθηκε παραπάνω, τα οποία θα σου φανούν χρήσιμα:
